...
public abstract class AbstractDatasourceBasedCheckFunction<T extends BasicProperties, W, R> implements DatasourceBasedChecker.DatasourceBasedCheckFunction {
    ...
    public void check(String domainKey, String[] fields, Object[] values) throws ConstraintViolationException {
        ...
        Function<String, String> fieldNameTransformer = fieldNameTransformer();
        for (int i = 0; i < fields.length; i++) {
            String field = fields[i];
            Object value = values[i];
            fieldSetter.accept(fieldNameTransformer.apply(field), value);
        }
    ...
    /**
     * Provides a function to transform field names, e.g., from camelCase to snake_case.
     * This method can be overridden to provide a different transformation if needed.
     *
     * @return a function that transforms field names
     */
    @Nonnull
    protected Function<String, String> fieldNameTransformer() {
