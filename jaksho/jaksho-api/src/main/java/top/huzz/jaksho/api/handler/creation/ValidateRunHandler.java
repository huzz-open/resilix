 ...
 */
@Component
public class ValidateRunHandler<R, T extends DomainDescription> extends PredictableRunHandler<CreateRunContext<R, T>> {

    protected ValidateRunHandler(List<HandlerRunPredicate<CreateRunContext<R, T>>> handlerRunPredicates) {
