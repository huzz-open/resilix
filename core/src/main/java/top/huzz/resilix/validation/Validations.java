...
public class Validations implements ApplicationRunner {
    ...
    private static class DatasourceValidations {
        ...
        private static boolean unique(String domainKey, Object... any) {
            return valid(TypedDatasourceBasedChecker.BuiltIn.UNIQUE, domainKey, any);
        }
         ...
         */
        public static boolean valid(TypedDatasourceBasedChecker.Type type, String domainKey, Object... any) {
            ...
            validationContext.executeCustomValidation(
                    (constraintDescriptor, path) -> {
                        ...
                        Checker checker = typedDatasourceBasedCheckerProvider.getChecker(type, domainKey, field);
                        checker.check(any);
                    });
            return true;
        }
