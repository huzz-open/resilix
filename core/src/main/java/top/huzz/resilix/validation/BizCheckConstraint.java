...
public class BizCheckConstraint implements ConstraintValidator<BizCheck, Object> {
    ...
    private static volatile List<LeadingFieldValueProvider> leadingFieldValueProviders;
    ...
    public void initialize(BizCheck constraintAnnotation) {
        ...
        initLeadingFieldValueProviders();
    ...
    public boolean isValid(Object input, ConstraintValidatorContext context) {
        try {
            if (context instanceof ConstraintValidatorContextImpl ctxImpl) {
                Validations.setValidationContext(new ValidationContext(ctxImpl, leadingFieldValueProviders));
            }
    ...
    private static void initLeadingFieldValueProviders() {
        if (leadingFieldValueProviders == null) {
            synchronized (BizCheckConstraint.class) {
                if (leadingFieldValueProviders == null) {
                    leadingFieldValueProviders = ApplicationContextUtils.listBean(LeadingFieldValueProvider.class);
                }
            }
        }
    }
