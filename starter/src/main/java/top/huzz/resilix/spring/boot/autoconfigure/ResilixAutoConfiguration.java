...
import top.huzz.resilix.validation.checker.NotImplDatasourceBasedCheckFunctionProvider;
...
public class ResilixAutoConfiguration {
    ...
    @ConditionalOnMissingBean
    public Validations validations(List<ReducibleMethodProvider> reducibleMethodProviders, Validator validator, TypedDatasourceBasedCheckerProvider checkerProvider) {
        return new Validations(reducibleMethodProviders, validator, checkerProvider);
    }
    ...
    @Bean(name = "resilixDatasourceBasedCheckFunctionProvider")
    @ConditionalOnMissingBean(DatasourceBasedCheckFunctionProvider.class)
    public DatasourceBasedCheckFunctionProvider datasourceBasedCheckFunctionProvider() {
        return new NotImplDatasourceBasedCheckFunctionProvider();
    }

    @Bean(name = "resilixTypedDatasourceBasedCheckerProvider")
    @ConditionalOnMissingBean
    public TypedDatasourceBasedCheckerProvider typedDatasourceBasedCheckerProvider(DatasourceBasedCheckFunctionProvider provider) {
        return new TypedDatasourceBasedCheckerProvider(provider);
    }
}
